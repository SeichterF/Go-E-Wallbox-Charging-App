...
struct ChargingSettings: Equatable {
    ...
    /// Charge energy limit in Wh for go-e `dwo`: energy still needed in the battery until target SOC, converted to Wh, multiplied by `chargingEnergyFactor` (e.g. 0.85).
